...
public interface ServiceMapper {
    ...
    List<ServiceVO> serviceStaticByEid(Integer serviceId, Integer startTime, Integer endTime, Integer eid);

    List<ServiceVO> serviceStaticByEid2(Integer serviceId, Integer startTime, Integer endTime, Integer eid);
}
