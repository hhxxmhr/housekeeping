    ...
    <div>
      <el-row class="margin-bottom">
        <el-form :model="searchForm" :inline="true" >
          ...
          <el-button type="primary" @click="exportExcel" style="float: right" icon="el-icon-download">导出为Excel</el-button>
        </el-form>
      </el-row>
      <el-table :data="fundList" border style="width: 100%" v-loading="loading" id="out-table">
        ...
        <el-table-column prop="detail" align="center" label="订单详情">
  ...
  export default {
    ...
    methods: {
      ...
      initQuery() {
        ...
        this.searchForm.startTime = this.searchForm.startTime ? parseInt(this.searchForm.startTime) : null;
        this.searchForm.endTime = this.searchForm.endTime ? parseInt(this.searchForm.endTime) : null;
